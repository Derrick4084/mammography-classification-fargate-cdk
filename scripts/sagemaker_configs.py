...
def get_framework_img_uri():
     uri = image_uris.retrieve(region="us-east-1", framework="image-classification")
     return uri
...
def get_sagemaker_uris(model_id,model_task_type,instance_type,region_name):
    ...
    image_uri = sagemaker.image_uris.retrieve(region="us-east-1", framework="image-classification")
